        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <hr/>
                    <form id="updateForm" action="{{route('category.update',$category->ma_tloai)}}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col mb-3">
                                <label class="form-label">ID Of Category</label>
                                <input type="text" name="ma_tloai" class="form-control" placeholder="ID" value="{{ $category->ma_tloai}}" readonly>
                            </div>
                            <div class="col mb-3">
                                <label class="form-label">Name Of Category</label>
                                <input type="text" name="ten_tloai" class="form-control" placeholder="Name Of Category" value="{{ $category->ten_tloai}}" require> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="d-grid">
